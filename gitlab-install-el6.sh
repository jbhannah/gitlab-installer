...
echo "y" | yum install patch gcc-c++ readline-devel libffi-devel make autoconf automake libtool bison libxml2-devel libxslt-devel libyaml-devel gettext gettext-devel expat-devel curl-devel zlib-devel openssl-devel cpan
